...
import AllNews from '@/components/AllNews.vue';
    ...
    export default {
        components: {Header, Footer, AllNews},
        data() {
            return {
                tabs: [
                    {
