...
<footer class="container footer flex">
        ...
        <div class="footer__center">
            ...
            <ul class="list-reset footer__personal">
                <li class="personal_item"><a class="footer_link link_personal" href="#">Пользовательское соглашение</a>
                </li>
                <li class="personal_item"><a class="footer_link link_personal" href="#">Политика о персональных
                        данных</a></li>
            </ul>
        </div>
