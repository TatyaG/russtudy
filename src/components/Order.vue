                            ...
                            <label v-for="book in books" :key="book.id" class="product">
                                ...
                                <div v-if="!book.isOnline" class="product__count count">
                                    ...
                                    <div class="count__block">
                                        ...
                                        <input type="number" class="count__num" value="0" v-model.number="productAmount" :name="'count['+ book.id +']'">
  ...
  <path d="M6 9.5V9.505M6 7.5V2.5" stroke="#0A2B49" stroke-linecap="round" stroke-linejoin="round"/>
                                    ...
                                    <div class="flex sub__block">
                                        <label class="sub__label">
                                            <input type="radio" class="visually-hidden" :name="'sub['+ book.id +']'" value="year">
                                            <span></span>
                                            1 год
                                        </label>
                                        <label class="sub__label">
                                            <input type="radio" class="visually-hidden" :name="'sub['+ book.id +']'" value="always">
                                            <span></span>
                                            Навсегда
                                        </label>
                            ...
                            <div class="order__block payment">
                                ...
                                <div class="payment__block">
                                    ...
                                    <input type="radio" class="visually-hidden" name="payment">
                                    <span></span>
                        ...
                        <div class="order__right">
                            <div class="order__block">
                                ...
                                <div class="between-block">
                                    <p class="order__text">Товары, 0 шт.</p>
